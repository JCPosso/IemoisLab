...
public class Iemois{
     ...
     */
    public void adicione(String nombre, String area,  String objetivo, String  distribuidor, String semanas) throws IemoisException {
		for (Mooc materia:cursos){
			if(materia.getNombre().equals(nombre)){
				throw new IemoisException(IemoisException.CURSO_YA_EXISTE);
			}
		}
		Integer.parseInt(semanas);
		if(distribuidor.equals("")){
			throw new IemoisException(IemoisException.DISTRIBUIDOR_DESCONOCIDO);
		}
		if(objetivo.equals("")){
			throw new IemoisException(IemoisException.INFORMACION_DESCONOCIDA);
		}
