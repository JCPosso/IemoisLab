...
public class IemoisGUI extends JFrame{
   ...
   /**
    ...
    private void  accionAdicionar()  {
		try{
			coleccion.adicione(textoNombre.getText(),textoArea.getText(),textoObjetivo.getText(), textoDistribuidor.getText(),textoSemanas.getText()); 
		}catch(IemoisException ie){
			JOptionPane.showMessageDialog(this,ie.getMessage(),"ERROR",JOptionPane.INFORMATION_MESSAGE);
		}catch(NumberFormatException ie2){
			JOptionPane.showMessageDialog(this,"Número de semanas invalido","ERROR",JOptionPane.INFORMATION_MESSAGE);
		}
    }
